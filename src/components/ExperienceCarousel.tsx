      ...
      {canNavigate && showControls && (
        <>
          <button
            ...
            onClick={goPrev}
            disabled={atStart}
            className={`fixed left-0 top-0 h-svh w-12 z-50 flex items-center justify-center text-white backdrop-blur-sm transition-opacity duration-200 ${
          ...
          <button
            ...
            onClick={goNext}
            disabled={atEnd}
            className={`fixed right-0 top-0 h-svh w-12 z-50 flex items-center justify-center text-white backdrop-blur-sm transition-opacity duration-200 ${
